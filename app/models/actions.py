...
class SuggestedAction(db.Model):
    ...
    # ondelete="SET NULL" mirrors migration 6f53c92d3337, which applied
    # it to production when campaigns became hard-deletable. Same drift
    # as campaigns.source_recipe_id: the model was never updated, so the
    # test schema enforced RESTRICT where production enforces SET NULL.
    source_campaign_id = db.Column(
